...
extern void          Abc_SclTimeNtkPrint( SC_Man * p, int fShowAll, int fPrintPath, char* cirNodeFileStr );
...
extern void          Abc_SclTimePerform( SC_Lib * pLib, Abc_Ntk_t * pNtk, int nTreeCRatio, int fUseWireLoads, int fShowAll, int fPrintPath, int fDumpStats, char* criNodeFileStr);
