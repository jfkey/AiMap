...
extern void            Map_printSuperLib( Map_SuperLib_t * p );
extern void            Map_MappingWriteNodeCut(Map_Man_t * pMan, Map_SuperLib_t * p, char* nodeFileStr, char*cutFileStr);
extern void            Map_MappingLoadNodeCutDelay(Map_Man_t * pMan, Map_SuperLib_t * p, char* preDelayStr);
